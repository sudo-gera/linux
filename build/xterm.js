    ...
    return function(e) {
            ...
            C = function(e) {
                function t(t, r, i, n, o, l, h, d, v) {
                    ...
                    return y._parser.setEscHandler({
                        ...
                        intermediates: "$",
                        final: "q"
                    }, new m(y._bufferService, y._coreService, y._logService, y._optionsService)), y
                }
        ...
        var o = r(36),
            ...
            O = function(e) {
                ...
                return n(t, e), Object.defineProperty(t.prototype, "options", {
                    ...
                    T.body.contains(e) || this._logService.debug("Terminal.open was called on an element that was not attached to the DOM"), this._document = e.ownerDocument, this.element = this._document.createElement("div"), this.element.dir = "ltr", this.element.classList.add("terminal"), this.element.classList.add("xterm"), this.element.setAttribute("tabindex", "0"), e.appendChild(this.element);
        ...
        var o = r(18),
            ...
            f = function(e) {
                function t(t, r) {
                    var i = e.call(this) || this;
                    i._terminal = t, i._renderService = r, i._liveRegionLineCount = 0, i._charsToConsume = [], i._charsToAnnounce = "", i._accessibilityTreeRoot = document.createElement("div"), i._accessibilityTreeRoot.classList.add("xterm-accessibility"), i._rowContainer = document.createElement("div"), i._rowContainer.classList.add("xterm-accessibility-tree"), i._rowContainer.setAttribute("role", "document"), i._rowElements = [];
